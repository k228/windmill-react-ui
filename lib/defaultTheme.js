...
var _default = {
  ...
  // TableHeader
  tableHeader: {
    base: 'text-xs font-semibold tracking-wide text-start text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800'
  },
  // TableContainer
  tableContainer: {
  ...
  // ModalFooter
  modalFooter: {
    base: 'flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-s-6 sm:flex-row bg-gray-50 dark:bg-gray-800'
  },
  // ModalHeader
  modalHeader: {
